...
\begin{figure}
\includegraphics[bb=0 0 2500 2500,scale=\textwidth]{images/grad_0.png}
\caption{Network structure of gradient data with a GLASSO regularization parameter of 0 (no regularization).}
\label{fig:grad_0}
\end{figure}

\begin{figure}
\includegraphics[bb=0 0 2500 2500,scale=\textwidth]{images/grad_50.png}
\caption{Network structure of gradient data with a GLASSO regularization parameter of 50.}
\label{fig:grad_50}
\end{figure}

\begin{figure}
\includegraphics[bb=0 0 2500 2500,scale=\textwidth]{images/grad_100.png}
...
\begin{figure}
\includegraphics[bb=0 0 200 100,width=\linewidth]{images/plate_models.png}
...
precision matrix for relations between the various variables in the data.
